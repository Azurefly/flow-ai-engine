...
function FlowConsole({ user, onLogout }: { user: UserIdentity; onLogout: () => void }) {
  ...
  return <main className="min-h-screen bg-slate-100 text-slate-800">
    ...
    <div className="flex min-h-[calc(100vh-56px)] flex-col md:flex-row">
      <aside className={`${sidebarOpen ? "w-full md:w-72" : "h-0 w-full overflow-hidden md:h-auto md:w-0"} shrink-0 border-b border-slate-200 bg-white transition-[width,height] duration-200 md:border-b-0 md:border-r`}>
      ...
      <section className="min-w-0 w-full flex-1">{section === "flows" && <FlowDesigner
